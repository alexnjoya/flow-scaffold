  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 py-4 px-6 transition-all duration-300 bg-white shadow-sm">
      <nav className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <Link 
          href="/chat" 
          className="bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:opacity-90 px-5 py-2 text-base font-medium rounded-lg shadow-lg transition-all duration-300"
        >
          Launch App
        </Link>
      </nav>
